...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "RaIOSdkBinary",
            url: "https://github.com/dokienkkk/RaIOSdk/releases/download/0.0.16/RaIOSdk-0.0.16.xcframework.zip",
            checksum: "a2b48a643cf5b36ee25e9d704c0a35564bc995e57b5e4dc2d9a0d374b9e526df"
        ),
        .target(
            name: "RaIOSdkWrapper",
            dependencies: [
