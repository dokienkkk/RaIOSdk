...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "RaIOSdkBinary",
            url: "https://github.com/dokienkkk/RaIOSdk/releases/download/0.0.13/RaIOSdk-0.0.13.xcframework.zip",
            checksum: "9182a82f3ff0bc759bfbcb91c5aeefe27e8f8af0341d52fbf67b705c09beb4d2"
        ),
        .target(
            name: "RaIOSdkWrapper",
            dependencies: [
