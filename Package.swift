...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "RaIOSdkBinary",
            url: "https://github.com/dokienkkk/RaIOSdk/releases/download/0.0.9/RaIOSdk-0.0.9.xcframework.zip",
            checksum: "c8a478f9e17da8473280243308fbebc0ff149cc4bd3170f801493353774b8dbc"
        ),
        .target(
            name: "RaIOSdkWrapper",
            dependencies: [
